const CACHE = "classroom-rpg-v126-20260824-production-login-v1";
const CORE = ["./", "./index.html", "./manifest.webmanifest", "./assets/app-icon.svg", "./Lession/Lessionindex.html", "./Lession/question-bank.html", "./Lession/question-bank-data.js", "./Lession/math-dungeon.html", "./Lession/學生名冊匯入範例.xlsx"];
